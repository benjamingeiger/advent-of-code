...
let insertMarble numPlayers (scores, circle) i =
    ...
    then
        ...
        let addedPoints = (i + popped) |> bigint
        let totalScore = (findKeyWithDefault 0I currentPlayer scores) + addedPoints
...
let result = Seq.fold (insertMarble numPlayers) (Map.empty, Deque.empty) (Seq.init (numMarbles * 100 + 1) id)
