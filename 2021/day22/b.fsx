...
let volume cuboid = bigint (cuboid.high.x - cuboid.low.x + 1) * bigint (cuboid.high.y - cuboid.low.y + 1) * bigint (cuboid.high.z - cuboid.low.z + 1)
...
let addVolumes space =
    ...
    step 0I (space |> Set.ofList |> Set.toList)
